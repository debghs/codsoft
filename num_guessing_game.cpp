		...
		if (difficultyChoice == 1) {
			...
			for (int i = 1; i <= 10; i++) 
            {
				...
				if (playerChoice == secretNumber) {
					...
					if (playerChoice > secretNumber) {cout << "Guess Lower."<< endl;}
		...
		else if (difficultyChoice == 2)
        {
			...
			for (int i = 1; i <= 7; i++)
            {
				...
				if (playerChoice == secretNumber)
                {
					...
					if (playerChoice > secretNumber){cout << "The secret number is smaller than the number you have chosen"<< endl;}
					else {cout << "The secret number is greater than the number you have chosen"<< endl;}
					choicesLeft--;
					cout << choicesLeft << " choices left. "<< endl;
					if (choicesLeft == 0)
                    {
